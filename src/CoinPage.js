      ...
      {/* <div>ATH: ${coin.market_data.market_cap.usd.toLocaleString()}</div> */}
        <table className='data-table'>
          <tbody>
            ...
            <tr className='row'><td>Fully Diluted Valuation</td><td>${coin.market_data.fully_diluted_valuation.usd.toLocaleString()}</td></tr><hr />
          </tbody>
        </table>
        <table className='data-table'>
          <tbody>
            ...
            <tr className='row'><td>Max Supply</td><td>{coin?.market_data.max_supply.toLocaleString()}</td></tr><hr />
          </tbody>
        </table>
